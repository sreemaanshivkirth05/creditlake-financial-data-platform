...
| Browser interaction QA | Workspace navigation, temporal filters, source details, exports, and quality views | `evidence/dashboard-validation.json` |
| Desktop and mobile rendering | Standalone preview verified at 1365px and 390px; no page overflow | `../demo/dashboard-desktop.jpg`, `../demo/dashboard-mobile.jpg` |
...
The refreshed interface was inspected in the self-contained preview using a
Chromium browser at desktop and mobile viewport widths. Backend API behavior
is checked separately by the Python suite and serving smoke script; this does
not establish browser testing of the refreshed API-backed interface. AWS and
Snowflake deployment remain extensions. Windows and macOS were not used for
validation.
